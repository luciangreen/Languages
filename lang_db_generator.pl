...
load_lang_db1(Entry3) :-
	...
	directory_files("languages/",F),
	delete_invisibles_etc(F,G),
	findall(Entry2,(member(Filex1,G),
	string_concat("languages/",Filex1,Filex),
		...
		string_concat("languages/",Target_language2,Target_language3),
...
findall([Input,Input1,Target_language10,Output3],(member([Input,Input1],List_of_words2),translate(Input1,"en",Target_language10,Output3)),Output4),
	...
	concat_list(["languages/",Target_language10,".txt"],File1),
...
translate1(Input,"en",Target_language1,Output3) :-
concat_list([Input," en ",Target_language1],Output3).
...
%% error if lang not found
	...
	(concat_list(["Error: Language: ",Lang," not in /languages folder."],Notification1),writeln(Notification1),abort))),
